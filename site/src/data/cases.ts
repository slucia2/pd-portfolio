...
export const cases: CaseStudy[] = [
  {
    ...
    imageAlt: 'Group Management detail: dynamic group with members, applied pages, rule, and activity log',
  ...
  },
  {
    ...
    imageAlt: 'MyIntake landing page: your health, in your hands',
    imageFit: 'cover',
    imagePosition: 'top',
    hideCaseHero: true,
  },
  {
    ...
    image: '/images/site-architecture/sa-hierarchy.png',
    imageAlt: 'Approved L1 categories and four-level site hierarchy mapping',
    imageFit: 'contain',
    cardFit: 'contain',
    cardPosition: 'top',
  },
